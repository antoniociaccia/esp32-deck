...
uint16_t FT6336U::read_touch1_x(void) {
  uint8_t readBuf[2];
  readBuf[0] = readByte(FT6336U_ADDR_TOUCH1_X);
  readBuf[1] = readByte(FT6336U_ADDR_TOUCH1_X + 1);
  return ((readBuf[0] & 0x0f) << 8) | readBuf[1];
}

uint16_t FT6336U::read_touch1_y(void) {
  uint8_t readBuf[2];
  readBuf[0] = readByte(FT6336U_ADDR_TOUCH1_Y);
  readBuf[1] = readByte(FT6336U_ADDR_TOUCH1_Y + 1);
  return ((readBuf[0] & 0x0f) << 8) | readBuf[1];
}
...
uint16_t FT6336U::read_touch2_x(void) {
  uint8_t readBuf[2];
  readBuf[0] = readByte(FT6336U_ADDR_TOUCH2_X);
  readBuf[1] = readByte(FT6336U_ADDR_TOUCH2_X + 1);
  return ((readBuf[0] & 0x0f) << 8) | readBuf[1];
}

uint16_t FT6336U::read_touch2_y(void) {
  uint8_t readBuf[2];
  readBuf[0] = readByte(FT6336U_ADDR_TOUCH2_Y);
  readBuf[1] = readByte(FT6336U_ADDR_TOUCH2_Y + 1);
  return ((readBuf[0] & 0x0f) << 8) | readBuf[1];
}
...
uint16_t FT6336U::read_library_version(void) {
  uint8_t readBuf[2];
  readBuf[0] = readByte(FT6336U_ADDR_LIBRARY_VERSION_H);
  readBuf[1] = readByte(FT6336U_ADDR_LIBRARY_VERSION_L);
  return ((readBuf[0] & 0x0f) << 8) | readBuf[1];
}
